...
This document provides instructions and context for autonomous agents working in the `ml-training` repository.

## Workflow Rules
1. **Environment Awareness**: Always run python scripts using the virtual environment in `.venv`.
